...
public interface RobotMap {
    ...
    int DRIVETRAIN_LINE_SENSOR_LEFT_PORT = 8;
    int DRIVETRAIN_LINE_SENSOR_RIGHT_PORT = 9;
    int DIO_ENCODER_PULSES_PER_REVOLUTION = 360;

    double DRIVETRAIN_WHEEL_DIAMETER = 7.5;
    int DRIVETRAIN_ENCODERS_PULSES_PER_REVOLUTION = 256;

    double DRIVETRAIN_WHEEL_CIRCUMFERENCE = DRIVETRAIN_WHEEL_DIAMETER * Math.PI;
    double DRIVETRAIN_ENCODER_INCHES_PER_PULSE = DRIVETRAIN_WHEEL_CIRCUMFERENCE / DRIVETRAIN_ENCODERS_PULSES_PER_REVOLUTION;
